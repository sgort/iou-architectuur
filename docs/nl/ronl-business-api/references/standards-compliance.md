...
Reference: [Nederlandse API
Strategie](https://docs.geostandaarden.nl/api/API-Strategie/)
...
All dependencies use government-compatible open source licences. No proprietary
...
- [BIO — Baseline Informatiebeveiliging
  Overheid](https://www.digitaleoverheid.nl/overzicht-van-alle-onderwerpen/cybersecurity/bio-en-ensia/)
