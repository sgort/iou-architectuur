...
In development and ACC environments, test users are mapped to BSN numbers via
...
**Note:** All test users currently map to the same persona (Wessel Kooyman). In
future, additional personas with different life situations will be added.
...
- [Haal Centraal BRP API
  Documentation](https://github.com/VNG-Realisatie/Haal-Centraal-BRP-bevragen)
