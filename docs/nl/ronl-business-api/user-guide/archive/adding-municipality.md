...
!!! info "Documentatie in ontwikkeling"
    ...
    Raadpleeg de <a href="/ronl-business-api/user-guide/archive/adding-municipality/">Engelse versie</a> voor de huidige inhoud.

---

**Status:** Concept  
**Engelstalige bron:** `ronl-business-api/user-guide/archive/adding-municipality.md`
