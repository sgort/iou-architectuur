...
!!! info "Documentatie in ontwikkeling"
    ...
    Raadpleeg de <a href="/cpsv-editor/developer/changelog-roadmap/">Engelse versie</a> voor de huidige inhoud.

---

**Status:** Concept
**Engelstalige bron:** `cpsv-editor/developer/changelog-roadmap.md`
