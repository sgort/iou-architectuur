...
The CPRMV vocabulary is defined in `rdf/cprmv.ttl` and published as the CPRMV
specification at
[acc.cprmv.open-regels.nl/respec/](https://acc.cprmv.open-regels.nl/respec/).
This page provides a compact reference of the classes and properties relevant to
the API's output.
...
The full alignment table and rationale are in the [CPRMV
specification](https://acc.cprmv.open-regels.nl/respec/).
