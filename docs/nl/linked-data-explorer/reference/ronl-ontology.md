...
The Linked Data Explorer uses a subset of the RONL Ontology v1.0 for two
features: governance validation badges and vendor service discovery.

For the full ontology specification — all 9 governance properties, the vendor
vocabulary, namespace definitions, parser configuration, and UI validation rules
— see:

**[CPSV Editor → References → RONL
...
Combined with `schema:provider`, `schema:url`, `schema:license`, `foaf:homepage`
for contact and service details.
